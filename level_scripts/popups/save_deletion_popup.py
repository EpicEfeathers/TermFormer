...
class SaveDeletionPopup:
    ...
    def show_popup(self, screen):
        ...
        text = "Enter to delete"
        self.popup_creator.add_coloured_text(screen, text, text_colour=termColours.black, background_colour=termColours.popup_gray, coloured_words="Enter", y=int(self.dimensions[1]/2) - 9)
